    ...
    public class CategoriesAPiController : ControllerBase
    {
...

        {
            ...
            foreach (var item in allSubInCategory)
            {
                ...
                var products = await _context.Products.Where(a => a.SubcategoryId == item.SubcategoryId && a.Color == color).Include(a => a.Promotion).Include(c => c.ProdCarts).Include(p => p.ProdOrders).Include(o => o.ProductImages).Include(i => i.Reviews).Include(y => y.Views).ToArrayAsync();
        ...
        {//id is category id
            ...
            foreach (var item in allSubInCategory)
            {
                var products = await _context.Products.Where(a => a.SubcategoryId == item.SubcategoryId && a.Price == price).Include(a => a.Promotion).Include(c => c.ProdCarts).Include(p => p.ProdOrders).Include(o => o.ProductImages).Include(i => i.Reviews).Include(y => y.Views).ToListAsync();
        ...
        {//id is category id
            ...
            foreach (var item in allSubInCategory)
            {
                ...
                var products = await _context.Products.Where(a => a.SubcategoryId == item.SubcategoryId).Include(a => a.Promotion).Include(c => c.ProdCarts).Include(p => p.ProdOrders).Include(o => o.ProductImages).Include(i => i.Reviews).Include(y => y.Views).ToListAsync();
        ...
        {//id is category id
            ...
            foreach (var item in allSubInCategory)
            {
                var products = await _context.Products.Where(a => a.SubcategoryId == item.SubcategoryId && a.Size == size).Include(a => a.Promotion).Include(c => c.ProdCarts).Include(p => p.ProdOrders).Include(o => o.ProductImages).Include(i => i.Reviews).Include(y => y.Views).ToListAsync();
        ...
        {//id is brand id
            ...
            var products = await _context.Products.Where(a => a.BrandId == id).Include(a => a.Promotion).Include(c => c.ProdCarts).Include(p => p.ProdOrders).Include(o => o.ProductImages).Include(i => i.Reviews).Include(y => y.Views).Include(q => q.Subcategory).ToListAsync();
        ...
        {//id is brand id
            ...
            var products = await _context.Products.Where(a => a.BrandId == id).Include(a => a.Promotion).Include(c => c.ProdCarts).Include(p => p.ProdOrders).Include(o => o.ProductImages).Include(i => i.Reviews).Include(y => y.Views).ToListAsync();
        ...
        {//id is subcategory id
            ...
            var products = await _context.Products.Where(a => a.SubcategoryId == id).Include(a => a.Promotion).Include(c => c.ProdCarts).Include(p => p.ProdOrders).Include(o => o.ProductImages).Include(i => i.Reviews).Include(y => y.Views).ToListAsync();
            foreach (var item in products)
            {
