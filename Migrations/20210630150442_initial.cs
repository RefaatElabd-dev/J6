        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsActive = table.Column<bool>(type: "bit", fixedLength: true, nullable: false, defaultValue: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    paymenttype = table.Column<string>(type: "nchar(50)", fixedLength: true, maxLength: 50, nullable: true, defaultValue: "PayPal")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    size = table.Column<int>(type: "int", fixedLength: true, maxLength: 10, nullable: false),
                    ProductName = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Model = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Rating = table.Column<double>(type: "float", nullable: false, defaultValue: 3.7999999999999998),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProdOrders", x => new { x.OrderId, x.ProductId });
                    table.ForeignKey(
